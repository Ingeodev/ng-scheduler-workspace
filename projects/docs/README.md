# ng-scheduler Documentation Site
...
1. **Layout Layer** (`docs/layout/`)
   - Componentes estructurales que definen el diseño general
   - `DocsLayoutComponent`: Contenedor principal que combina header, sidebar y content
   - `HeaderComponent`: Navegación superior fija con branding y links externos
   - `SidebarComponent`: Navegación lateral con secciones (Getting Started, Components, API)
